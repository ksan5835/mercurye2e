...
$app->get('api/v1/customer/emailbook/{email}/{branch_id}/{service_id}/{bookdate}/{timeinterval1}/{timeinterval2}/{timezone_id}/{type}','CustomerController@getCustomerEmailBooking');
