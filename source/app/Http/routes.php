...
$app->get('api/v1/matrix1/{provider_email}/{user_email}/{branch1_id}/{service1_id}/{start_date}/{timezone_id}/{frequency}','CustomerController@getMatrix1_Result');

$app->get('api/v1/matrix2/{provider_email}/{user_email}/{branch1_id}/{service1_id}/{start_date}/{timezone_id}/{frequency}','CustomerController@getMatrix2_Result');
