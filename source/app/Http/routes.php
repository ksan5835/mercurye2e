...
$app->get('api/v1/matrix3/{provider_email}/{user_email}/{branch1_id}/{service1_id}/{service2_id}/{start_date}/{timezone_id}/{frequency}','CustomerController@getMatrix3_Result');
